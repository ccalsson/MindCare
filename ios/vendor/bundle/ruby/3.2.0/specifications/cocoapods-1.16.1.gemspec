# -*- encoding: utf-8 -*-
# stub: cocoapods 1.16.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<cocoapods-core>.freeze, ["= 1.16.1".freeze])
  ...
  s.add_runtime_dependency(%q<xcodeproj>.freeze, [">= 1.26.0".freeze, "< 2.0".freeze])
